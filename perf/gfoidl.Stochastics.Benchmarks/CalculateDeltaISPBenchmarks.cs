            ...
            fixed (double* pArray = _values)
            {
                ...
                if (Vector.IsHardwareAccelerated && n >= Vector<double>.Count)
                {
                    ...
                    for (; i < m; i += 8 * Vector<double>.Count)
                    {
                        ...
                        Core(arr, 2 * Vector<double>.Count, avgVec, ref deltaVec0, end);
                        Core(arr, 3 * Vector<double>.Count, avgVec, ref deltaVec1, end);
                        Core(arr, 4 * Vector<double>.Count, avgVec, ref deltaVec0, end);
                        Core(arr, 5 * Vector<double>.Count, avgVec, ref deltaVec1, end);
                        Core(arr, 6 * Vector<double>.Count, avgVec, ref deltaVec0, end);
                        Core(arr, 7 * Vector<double>.Count, avgVec, ref deltaVec1, end);
